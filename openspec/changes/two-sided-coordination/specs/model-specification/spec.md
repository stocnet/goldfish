...
Note: this delta is written against the wording `parametric-rates` leaves in
the living spec (that change archives first; see design D13).
...
- **THEN** a `goldfishSpec` object is returned carrying the
