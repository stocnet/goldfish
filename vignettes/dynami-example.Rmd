...
```
## Error: Error in DyNAMi choice estimation: Error: Active node 1 not available in event 14
```
...
```
## Error in eval(expr, envir, enclos): object 'est.choice.M1' not found
```
...
```
## Error in eval(expr, envir, enclos): object 'est.choice.M2' not found
```
