...
#> Error in coef(partnerModel): object 'partnerModel' not found
...
#> Error in summary(partnerModel): object 'partnerModel' not found
```
...
#> Error in tidy(tieModel): object 'tieModel' not found
```


```r
glance(tieModel)
#> Error in glance(tieModel): object 'tieModel' not found
```
...
#> Error in "result.goldfish" %in% attr(x, "class"): object 'tieModel' not found
examineChangepoints(tieModel)
#> Error in methods::is(x, "result.goldfish"): object 'tieModel' not found
```
