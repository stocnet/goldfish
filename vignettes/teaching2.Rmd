...
> Stadtfeld, Hollway & Block (2017), "Dynamic Network Actor Models: Investigating Coordination Ties through Time", Sociological Methodology, 2017, 47(1): 1-40. DOI: [10.1177/0081175017709295](https://journals.sagepub.com/doi/10.1177/0081175017709295 "Stadtfeld et al. (2017)")
...
<img src="teaching/plot-teaching2-1.png" title="plot of chunk plot-teaching2" alt="plot of chunk plot-teaching2" width="504" style="display: block; margin: auto;" />
...
#> inertia  2.8687399  0.2724550 10.5292 < 2.2e-16 ***
#> indeg    0.5058902  0.0661896  7.6430 2.132e-14 ***
#> trans    0.3128331  0.2140819  1.4613  0.143939    
#> tie      1.0951108  0.2224272  4.9235 8.503e-07 ***
#> alter    0.0046804  0.0144157  0.3247  0.745429    
#> diff     0.0013902  0.0117902  0.1179  0.906140    
#> alter    5.0528318  1.5487636  3.2625  0.001104 ** 
#> diff    -3.0977424  1.5990442 -1.9372  0.052715 .  
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#>   Converged with max abs. score of 0.00024 
...
#> 1  bilatnet inertia W    0.134     0.048     2.816   0.005
#> 2      bilatnet indeg    0.568     0.058     9.854 < 0.001
#> 3      bilatnet trans    0.289     0.146      1.98   0.048
#> 4       contignet tie    1.648     0.184     8.956 < 0.001
#> 5 states regime alter   -0.015     0.016    -0.957    0.34
#> 6  states regime diff    0.008     0.013     0.651    0.52
#> 7    states gdp alter    6.089     1.516     4.015 < 0.001
#> 8     states gdp diff   -4.601     1.582    -2.908   0.004
```
