...
library(broom)
library(pixiedust)
#> Warning: package 'pixiedust' was built under R version 4.3.3
...
<div class="figure" style="text-align: center">
<img src="teaching/examine-1.png" alt="plot of chunk examine" width="432" />
<p class="caption">plot of chunk examine</p>
</div>
