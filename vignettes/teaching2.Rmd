...
```{r plot, message=FALSE, warning=FALSE, fig.width=7, fig.height=4, fig.align='center', fig.retina=3}
library(igraph)
library(migraph)
...
estPrefs <- list(
  ...
  initialDamping = 40,
  maxIterations = 30,
  initialParameters = coef(partner.model))
...
```{r examine, fig.width=6, fig.height=4, fig.align='center', fig.retina=3}
examineOutliers(tie.model)
examineChangepoints(tie.model)
```
