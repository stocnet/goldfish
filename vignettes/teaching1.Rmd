...
```r
library(goldfish)
#> Warning: package 'goldfish' was built under R version 4.3.2
...
#> Error in UseMethod("as_tidygraph"): no applicable method for 'as_tidygraph' applied to an object of class "NULL"
