...
<img src="figure/plot-teaching1-1.png" title="plot of chunk plot-teaching1" alt="plot of chunk plot-teaching1" width="504" />
...
<img src="figure/plot-teaching1-2.png" title="plot of chunk plot-teaching1" alt="plot of chunk plot-teaching1" width="504" />

```r

callNetworkEnd <- add_node_attributes(callNetworkEnd, "floor", actors$floor)
autographr(callNetworkEnd, labels = FALSE, layout = "fr") +
  geom_node_point(aes(color = as.factor(floor)), size = 2, show.legend = FALSE)
```

<img src="figure/plot-teaching1-3.png" title="plot of chunk plot-teaching1" alt="plot of chunk plot-teaching1" width="504" />
...
callNetworkHlf <- add_node_attributes(callNetworkHlf, "floor", actors$floor)
autographr(callNetworkHlf, labels = FALSE, layout = "fr") +
  geom_node_point(aes(color = as.factor(floor)), size = 2, show.legend = FALSE)
```

<img src="figure/plot-teaching1-4.png" title="plot of chunk plot-teaching1" alt="plot of chunk plot-teaching1" width="504" />
...
```r
allFormulaREM <- callsDependent ~ 1 + inertia(callNetwork) + recip(callNetwork) +
