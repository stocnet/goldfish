...
Contributions to `goldfish`, whether in the form of issue identification, bug fixes, new code or documentation are encouraged and welcome, both from research assistants and (early) users of the package:

* [Submit an issue](#issues)
* [Fix a bug or implement new features](#adding-new-code)
* [Document existing code](#documentation)

Please note that the `goldfish` project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
