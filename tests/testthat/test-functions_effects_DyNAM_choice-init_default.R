test_that("DyNAM default and tie init return the same result", {
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_tie, network = m1, attribute = NULL, window = NULL,
      n1 = 5, n2 = 5
    )
  )
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_tie, network = m1, attribute = NULL, window = 1, n1 = 5, n2 = 5
    ),
  ...
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_tie_weighted, network = m1, attribute = NULL, window = NULL,
      n1 = 5, n2 = 5
    ),
  ...
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_tie_weighted, network = m1, attribute = NULL, window = 1,
      n1 = 5, n2 = 5
    ),
  ...
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_tie_weighted, network = m0, attribute = NULL, window = NULL,
      n1 = 5, n2 = 5
    ),
...
test_that("DyNAM default and trans init return the same result", {
  expect_equal(
    ...
    init_DyNAM_choice.default(
      effectFUN_trans, network = m1, attribute = NULL, window = NULL,
      n1 = 5, n2 = 5
    )
  )
})
