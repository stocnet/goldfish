...
test_that("set_estimation_opt throw errors", {
  ...
  expect_error(set_estimation_opt(score_tol = -1))
  expect_error(set_estimation_opt(step_tol = -1))
...
test_that("set_estimation_opt deprecation warning for convergence_criterion", {
  expect_warning(
    set_estimation_opt(convergence_criterion = 1e-4),
