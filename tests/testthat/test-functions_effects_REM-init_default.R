test_that("REM default and ego init return the same result", {
  expect_equal(
    ...
    init_DyNAM_choice.default(effectFUN_REM_ego, network = NULL, attribute = testAttr$fishingComplete,
...
test_that("REM default and diff init return the same result", {
  expect_equal(
    ...
    init_DyNAM_choice.default(effectFUN_REM_diff, network = NULL, attribute = testAttr$fishingComplete,
...
test_that("REM default and same init return the same result", {
  expect_equal(
    ...
    init_DyNAM_choice.default(effectFUN_REM_sim, network = NULL, attribute = testAttr$fishingComplete,
                              window = NULL, n1 = 8, n2 = 8)$stat
  )
  expect_equal(
