...
choice_fn <-
  getFromNamespace("compute_event_contribution.dynam_choice_spec", "goldfish")
rem_ordered_fn <-
  getFromNamespace(
    "compute_event_contribution.rem_rate_ordered_spec",
    "goldfish"
  )
rate_ordered_fn <-
  getFromNamespace(
...
coord_fn <-
  getFromNamespace(
    "compute_event_contribution.dynam_choice_coord_spec",
    "goldfish"
  )
