# evaluate_model rejects what it cannot evaluate
    ...
    Condition
      ...
      i Valid quantities are "loglik", "score", "information", "interval_loglik", "total_rate", "conditional_logl", "event_scores", "conditional_scores", "ranks", "recall", "margins", "exposure", "n_opportunities", and "probabilities".
