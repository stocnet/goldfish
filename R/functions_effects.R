...
# - replaceObject # integer relating to the position of the data object in the signature
...
# - What if the network is two-mode? (e.g. if(sender == receiver) return(NULL) could not work)
...
#' @param window Identifies a window length within which changes should apply to events.
...
# TODO: Some effects under development deleted
...
# # TODO: Think about the effect and repair it
