...
init_DyNAM_choice_coordination <- function(effectFun, network, attribute, n1, n2, cache = NULL)
  UseMethod("init_DyNAM_choice")

# Structural effects ------------------------------------------------------
# tie ---------------------------------------------------------------------

update_DyNAM_choice_coordination_tie <- function(network,
...
# inertia -----------------------------------------------------------------
update_DyNAM_choice_coordination_inertia <- function(network,
                                                     sender, receiver, replace,
                                                     weighted = FALSE, transformFun = identity)
...
# indeg -------------------------------------------------------------------
update_DyNAM_choice_coordination_indeg <- function(network,
...
# outdeg -------------------------------------------------------------------
update_DyNAM_choice_coordination_outdeg <- function(network,
                                       sender, receiver, replace,
                                       cache, n1, n2,
                                       isTwoMode = FALSE,
                                       weighted = FALSE, transformFun = identity)
...
# trans -------------------------------------------------------------------
update_DyNAM_choice_coordination_trans <- function(network,
                                                   sender,
                                                   receiver,
                                                   replace, cache,
                                                   isTwoMode = FALSE,
...
# tertius ----------------------------------------------------------------
update_DyNAM_choice_coordination_tertius <- function(network,
                                                     attribute,
                                                     sender = NULL,
                                                     receiver = NULL,
                                                     node = NULL,
...
#'                                 aggregateFun = function(x) median(x, na.rm = TRUE))
#' }
update_DyNAM_choice_coordination_tertius_diff <- function(network,
                                                          attribute,
                                                          sender = NULL,
                                                          receiver = NULL,
                                                          node = NULL,
...
# node_trans ------------------------------------------------------------------
update_DyNAM_choice_coordination_node_trans <- function(network,
                                                        sender,
                                                        receiver,
                                                        replace,
                                                        cache,
...
# Covariate effects -------------------------------------------------------
# alter -------------------------------------------------------------------
update_DyNAM_choice_coordination_alter <- function(attribute,
                                                   node, replace,
                                                   n1, n2,
                                                   isTwoMode = FALSE)
...
# same --------------------------------------------------------------------
update_DyNAM_choice_coordination_same <- function(attribute,
                                                  node, replace,
                                                  isTwoMode = FALSE)
...
# diff --------------------------------------------------------------------
update_DyNAM_choice_coordination_diff <- function(attribute, node, replace,
                                                  n1, n2,
                                                  isTwoMode = FALSE,
                                                  transformFun = abs)
...
# sim ---------------------------------------------------------------------
update_DyNAM_choice_coordination_sim <- function(attribute, node, replace,
                                                 n1, n2,
                                                 isTwoMode = FALSE,
                                                 transformFun = abs)
