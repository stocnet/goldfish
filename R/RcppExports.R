...
#'
#' @noRd
estimate_DyNAM_MM <- function(parameters, dep_event_mat, stat_mat_init, stat_mat_update, stat_mat_update_pointer, stat_mat_broadcast, stat_mat_broadcast_pointer, active_sender_init, active_sender_update, active_sender_update_pointer, active_dyad_init, active_dyad_update, active_dyad_update_pointer, n_actors_1, n_actors_2, twomode_or_reflexive, impute = TRUE, active_dyad_is_point = FALSE, return_event_scores = FALSE, return_ranks = FALSE, return_margins = FALSE, return_probabilities = FALSE, return_availability = FALSE, event_weights = NULL, return_event_information_trace = FALSE) {
...
#' @noRd
compute_coordination_selection <- function(parameters, stat_all_events, n_candidates, selected, sender_of_row, dyad_partner, index_i, index_j, n_actors_1, return_event_scores, return_ranks, return_margins, return_probabilities = FALSE, return_availability = FALSE, event_weights = NULL, return_event_information_trace = FALSE) {
    .Call('_goldfish_compute_coordination_selection', PACKAGE = 'goldfish', parameters, stat_all_events, n_candidates, selected, sender_of_row, dyad_partner, index_i, index_j, n_actors_1, return_event_scores, return_ranks, return_margins, return_probabilities, return_availability, event_weights, return_event_information_trace)
}
...
#' @noRd
compute_multinomial_selection <- function(parameters, stat_all_events, n_candidates, selected, index_i, index_j, n_actors_1, n_actors_2, return_event_scores, return_ranks, return_margins, return_probabilities = FALSE, return_availability = FALSE, event_weights = NULL, return_event_information_trace = FALSE) {
    .Call('_goldfish_compute_multinomial_selection', PACKAGE = 'goldfish', parameters, stat_all_events, n_candidates, selected, index_i, index_j, n_actors_1, n_actors_2, return_event_scores, return_ranks, return_margins, return_probabilities, return_availability, event_weights, return_event_information_trace)
}
...
#' @noRd
compute_poisson_selection <- function(parameters, stat_all_events, n_candidates, selected, timespan, is_dependent, index_i, index_j, n_actors_1, n_actors_2, return_event_scores, return_ranks, return_margins, return_probabilities = FALSE, return_availability = FALSE, return_conditional_scores = FALSE, event_weights = NULL, return_event_information_trace = FALSE) {
    .Call('_goldfish_compute_poisson_selection', PACKAGE = 'goldfish', parameters, stat_all_events, n_candidates, selected, timespan, is_dependent, index_i, index_j, n_actors_1, n_actors_2, return_event_scores, return_ranks, return_margins, return_probabilities, return_availability, return_conditional_scores, event_weights, return_event_information_trace)
}
