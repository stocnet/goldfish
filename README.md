...
[![R-CMD-check](https://github.com/snlab-ch/goldfish/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/snlab-ch/goldfish/actions/workflows/R-CMD-check.yaml)
